...
## Project Structure
    ...
    ├── wandering_waterfall_97766  # Django project configurations
...
1. Clone this repo and `cd wandering_waterfall_97766`
...
2. Clone this repo and `cd wandering_waterfall_97766`
